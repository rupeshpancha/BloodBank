    ...
    <div class="container">
        ...
        <div class="content">
            ...
            if ($result->num_rows > 0 && $resultt->num_rows > 0) {
                echo "<table>";
                echo "<tr><th>Blood Group</th><th>Available Units</th></tr>";
                // Fetch and display data from the first query
                while ($row = $result->fetch_assoc()) {
                    echo "<tr><td>" . $row["bloodgroup"] . "</td><td>" . $row["count"] . "</td></tr>";
                }
                // Fetch and display data from the second query
                // while ($roww = $resultt->fetch_assoc()) {
                //     // echo "<tr><td>O (Donor Bloodgroup)</td><td>" . $roww["ct"] . "</td></tr>";
                // }
                echo "</table>";
            } else {
