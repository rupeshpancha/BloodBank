...
$sql = "INSERT INTO register_donor (f_name, m_name, l_name, gender, bloodgroup, email,contact, address,  form_fill_date,verified_date) 
        VALUES ('$f_name', '$m_name', '$l_name', '$gender', '$bloodgroup','$email','$contact', '$address',  '$form_fill_date','$verified_date')";
